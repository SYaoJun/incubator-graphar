...
enum class QUERY_TYPE : uint8_t {
  COUNT = 0,    // return the number of valid vertices
  INDEX = 1,    // return the indices of valid vertices
  BITMAP = 2,   // return the bitmap of valid vertices
  ADAPTIVE = 3  // adaptively return indices or bitmap
};
