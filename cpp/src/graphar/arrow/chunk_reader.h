...
class VertexPropertyArrowChunkReader {
 public:
  ...
  // accidental sharing of the LRU cache between reader instances.
  VertexPropertyArrowChunkReader(const VertexPropertyArrowChunkReader&) = delete;
  VertexPropertyArrowChunkReader& operator=(const VertexPropertyArrowChunkReader&) = delete;
